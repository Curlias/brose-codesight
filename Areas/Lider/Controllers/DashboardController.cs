...
namespace Brose_OnboardingDashboard.Areas.Lider.Controllers
{
    ...
    public class DashboardController : Controller
    {
        public IActionResult Index()
        {
            ...
            {
                new { Id = 1, Nombre = "Ana García", Puesto = "Ingeniero de Calidad", Progreso = 85, DiasOnboarding = 12, Riesgo = "Bajo", Planta = planta },
                new { Id = 3, Nombre = "Carlos López", Puesto = "Técnico de Producción", Progreso = 60, DiasOnboarding = 8, Riesgo = "Medio", Planta = planta },
                new { Id = 4, Nombre = "María Rodríguez", Puesto = "Analista de Logística", Progreso = 45, DiasOnboarding = 5, Riesgo = "Bajo", Planta = planta },
                new { Id = 2, Nombre = "José Martínez", Puesto = "Supervisor de Calidad", Progreso = 90, DiasOnboarding = 15, Riesgo = "Bajo", Planta = planta }
            };
