...
namespace Brose_OnboardingDashboard.Areas.Lider.Controllers
{
    ...
    public class PerfilEmpleadoController : Controller
    {
        public IActionResult Index(int? id)
        {
            ...
            // Datos mock del empleado seleccionado (mismo método que RH)
        ...
        {
            // Lista de empleados mock (mismos datos que en RH)
            var empleados = new List<dynamic>
            {
                ...
                new { Id = 6, Nombre = "Ana García", Puesto = "Ingeniero de Calidad", Area = "GKL", Departamento = "Calidad", Planta = "Benito Juárez", Lider = "Juan Pérez", FechaIngreso = "2024-10-12", DiasOnboarding = 12, Estado = "En Onboarding", Progreso = 85, Satisfaccion = 4.5, Riesgo = "Bajo", Email = "ana.garcia@brose.com", Telefono = "+52 442 678 9012" },
                new { Id = 7, Nombre = "Carlos López", Puesto = "Técnico de Producción", Area = "GE", Departamento = "Producción", Planta = "Benito Juárez", Lider = "Juan Pérez", FechaIngreso = "2024-10-16", DiasOnboarding = 8, Estado = "En Onboarding", Progreso = 60, Satisfaccion = 4.2, Riesgo = "Medio", Email = "carlos.lopez@brose.com", Telefono = "+52 442 789 0123" }
            };
